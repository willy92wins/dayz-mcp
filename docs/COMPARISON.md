...
| Vehicles | Enter, drive, telemetry, and trace. Drivability is certified in-game on a canonical test site (docs/VEHICLE_TESTING.md) and was reproduced end-to-end by three external agents. | No vehicle verbs. |
...
Vehicle driving carries an in-game certificate: a documented site protocol (docs/VEHICLE_TESTING.md) plus a multi-agent reproduction of the drive.
