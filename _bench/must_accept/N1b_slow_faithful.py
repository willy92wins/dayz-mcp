"""HOLDOUT N1b - lento pero correcto, FIEL.

El modulo real integro -generado desde su fuente, no copiado a mano- con 6 s de
retraso en la resolucion. N1 fallo porque al copiarlo a mano se me quedo fuera
_audit_desc_enum_mismatch; el gate lo cazo con un fixture sintetico. Esta version
no puede tener ese defecto porque no la escribi yo.

VEREDICTO ESPERADO: ACCEPT. Mide el timeout (CHILD_TIMEOUT_SECONDS=15).
"""
