"""Resolver that invents enum [True, False] when type is boolean and enum is absent.

Fixture booleans always carry that enum. Live booleans (dayz_test_run.build,
etc.) have no enum and must publish None.
"""
...
def _published_enum(pschema: dict[str, Any]) -> list[Any] | None:
    ...
    published = _published_type(pschema)
